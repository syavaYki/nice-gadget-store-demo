    ...
    <div className={classNames(style.container)}>
      ...
      <div className={classNames(style.categories_container)}>
        <div className={classNames(style.category_container)}>
          <Link to={'/phones'} className={classNames(style.category_link)}>
        ...
        <div className={classNames(style.category_container)}>
          <Link to={'/tablets'} className={classNames(style.category_link)}>
        ...
        <div className={classNames(style.category_container)}>
          <Link to={'/accessories'} className={classNames(style.category_link)}>
