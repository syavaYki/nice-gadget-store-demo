...
export const PicturesSlider = () => {
  ...
  return (
    <div className="photoSwiper_container">
      ...
      >
        <SwiperSlide>
          <img src="img\banner-accessories.png" alt="banner-accessorie" />
        </SwiperSlide>

        <SwiperSlide>
          <img src="img\banner-phones.png" alt="banner-phones" />
        </SwiperSlide>

        <SwiperSlide>
          <img src="img\banner-tablets.png" alt="banner-tablets" />
        </SwiperSlide>
      </Swiper>
